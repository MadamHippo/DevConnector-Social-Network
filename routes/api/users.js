    ...
    .then(user => {
      if (user){
        ...
        const newUser = new User({
          ...
          // now you set the avatar we just connected to above
          avatar // avatar on the right is the variable name in key:name value. Which means you can also just put avatar and JS will automatically deconstruct the key:value with the exact same name 'avatar'
        });
